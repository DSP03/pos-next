  ...
  return (
    ...
    <Layout>
      <div className="min-h-screen bg-[#F2F7F8] p-6">
        ...
        {/* CARD */}
        <div className="bg-white shadow-2xl rounded-3xl overflow-hidden border border-[#D9E5E7]">          {/* HEADER */}
          <div className="bg-gradient-to-r from-[#003C51] to-[#006E74] px-8 py-6">            <h2 className="text-3xl font-bold text-white">
              {title}
            </h2>
          ...
          <div className="p-8 space-y-6">
            ...
            {/* SUCCESS */}
            {success && (
                <div className="bg-cyan-50 border border-cyan-200 text-[#006E74] px-4 py-3 rounded-2xl shadow-sm">                <div className="font-semibold">
                  Success
                </div>
                <div className="text-sm mt-1">
                  {success}
            ...
            {/* FORM */}
              <div className="bg-white rounded-2xl p-6 border border-[#D9E5E7] shadow-sm">              <FormRenderer
                fields={fields}
                form={form}
                setForm={setForm}
                options={options}
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              ...
              <button
                ...
                className={`flex-1 py-3 rounded-2xl font-semibold text-white transition-all duration-300 shadow-lg ${
                  loading ? 'bg-[#7A7480] cursor-not-allowed'
